  ...
  <div>
    ...
    <section class="columns">
      ...
      <div class="content column is-three-fifth">
        ...
        <p>
          Despite being small creatures, bees are extremely important for the
          environment and humanity. There are over 20.000 bee species around the
          world, from social to solitary bees, sting bees to stingless bees. In
          Brazil only, there are about 3.000 bee species, the greatest diversity
          of bees in the whole world [1]! All of them serve many ecosystem
          services, including a very important one: <b>plant pollination</b>.
        </p>
        ...
        <p>
          ...
          most frequent floral visitor [3, 4,11].
        </p>
        <p>
          Bees are the main pollinators, responsible for the preservation of
          many plant species worldwide. In Brazil, a single group of bees (the
          stingless Meliponina) already contributes to the pollination of 40% to
          90% of all tree species,
          <b
            >maintaining the country's native forest and the ecosystems
            biodiversity</b
          >[2,3].
        </p>
        <p>
