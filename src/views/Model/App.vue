  ...
  <div>
    ...
    <section class="columns">
      ...
      <div class="content column is-three-fifth">
        ...
        <h4 style="font-size: 1.5rem;">Protein Modelling and Docking</h4>
        ...
        <p>
          We started our model construction by performing two steps to include the cofactor in the final protein model. First, we put CYP6g1 primary sequence in the highest-scoring CASP predict protein model servers (I-Tasser and Robetta). Once the best results were generated, we manually <b>added the heme group into CYP3A1</b> crystallography-solved model using <b>Modeller</b>. [1, 2]. (Figure 1).
        </p>

        <figure class="has-text-centered">
          <img
            src="https://2021.igem.org/wiki/images/a/af/T--USP-Brazil--IGEM-USP-Model-Scheme-of-building-model-CYP6G1.png"
          />
        </figure>

        <p>Selection of CYP3A4 as a template was based on a PSI-BLAST search [8], in which we searched for the most similar and already solved structure deposited in the PDB database. We chose CYP3A4 (<b>PDB: 4D6Z</b>), a <i>Human sapiens</i> Cythocrome P450 enzyme. The local alignment scores showed that the modeled CYP3A4  had 34% of similarity with the primary sequence of CYP6G1 and a coverage of 93% [4]. Results from the literature have indicated a similar catalytic function for imidacloprid degradation [3] and the presence of an important cysteine residue for covalent sulfur-iron bond. Additionally, that protein had already been used as a template for a CYP6G1 3D model[5]. </p>

        <p>
          In the urge of minimizing possible errors [6, 7, 9], we searched for a high crystallography resolution, <span v-text="`<2.5 Å`" />, and a good R-free value in PDB database, <span v-text="`<0.26`" />. Then, we checked the model for missing amino acids residues that could hinder our experiments by deforming the catalytic site [5, 7].</p>
        ...
        <figure class="has-text-centered">
          <img
            src="https://2021.igem.org/wiki/images/thumb/c/ce/T--USP-Brazil--IGEM-USP-Model-Important-residues-for-the-stabilization-of-carboxyl-groups-in-CYP450.png/1200px-T--USP-Brazil--IGEM-USP-Model-Important-residues-for-the-stabilization-of-carboxyl-groups-in-CYP450.png"
          />
        </figure>
        ...
        <h4 style="font-size: 1.5rem;">Exploration of pesticides interaction with CYP6G1</h4>
        
        <p>By comparing the models we built with the one generated by Alphaphold, we sought to understand how pesticides interacted in the catalytic site. However, unexpectedly, our model has presented a larger catalytic site than Alphaphold's (Figure 5) [5].</p>
        ...
        <p>We could use our model for docking experiments. However, in order to optimize the modelled structure and to validate the large catalytic site present on the CYP6G1, we would have to perform a short-time molecular dynamics experiment. This experiment would allow us to comprehend which bonds are essential in the many frames generated by programs as Gromacs and would also permit adjustments in the lateral amino acids residues.</p>

        <p>Besides, structural validation of the modelled CYP6G1 was also an issue. Free programs, such as Amber or Gromacs, did not have a necessary parametrization of metal groups making us use the support of the MCPB script. Then, We could achieve the parametrization of the heme group for our model of CYP6G1 by molecular and quantum mechanics calculations, using a plausible web protocol, that has expected for atomic positions for iron the charge +3. But, the late access to a supercomputer and time-demanding calculations made us run out of time to achieve the results we expected.</p>
        ...
        <p>
          Our approach to measuring the efficiency of our construct was to analyze the time period in which imidacloprid concentration would reach close-to-zero levels. Since CYP family enzymes obey Michaelis-Menten kinetics [3] we considered that the enzyme would behave as stated with the chemical equation:
        </p>
            ...
            <p>
              \[
                \begin{cases}
                  ...
                  C(n+1) = pe^{-\mu}C(n) + pe^{-\mu}[1 - e^{-\alpha}]U(n)
                \end{cases}\,
              \]
          </p>
          </div>
